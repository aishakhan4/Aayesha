...
WHERE
internpersnoldetail.uid=$id
AND
internprofessionaldetail.uid=$id";
...
<?php
  ...
  <tr>
    ...
    <td><h1><?php echo $row["aadhar_no"]; ?><h1></td>
  </tr>
  <tr>
    <th><h1>PAN CARD</th>
    <td><h1><?php echo $row["pan_card"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1>GENDER</h1></th>
    <td><h1><?php echo $row["gender"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1>DOB</h1></th>
    <td><h1><?php echo $row["date_of_birth"]; ?></h1></td>
    </tr>
    <tr>
      <th><h1>BLOOD GROUP</h1></th>
    <td><h1><?php echo $row["blood_group"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1>FATHER NAME</h1></th>
    <td><h1><?php echo $row["father_name"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1>FATHER OCCUPATION</h1></th>
    <td><h1><?php echo $row["father_occupation"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1>FATHER NUMBER</h1></th>
    <td><h1><?php echo $row["father_no"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1>CITY</h1></th>
    <td><h1><?php echo $row["city"]; ?></h1></td>
  </tr>
  <tr><th><h1>STATE</h1></th>
    <td><h1><?php echo $row["state"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1>PIN CODE</h1></th>
    <td><h1><?php echo $row["pin_code"]; ?></h1></td>
    </tr>
    <tr>
      <th><h1>ADDRESS</h1></th>
  ...
  <tr>
    <th><h1> High School Name</h1></th>
        <td><h1><?php echo $row["school_name"]; ?></h1></td>
    </tr>
    <tr>
      <th><h1>High school Board</h1></th>
    <td><h1><?php echo $row["board"]; ?><h1></td>
  </tr>
  <tr>
    <th><h1>High School Percent</h1></th>
    <td><h1><?php echo $row["percent"]; ?></h1></td>
  </tr>
  <tr>
      <th><h1>High School Passing Year</h1</th>
    <td><h1><?php echo $row["passing_year"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1> High Secondary School Name</h1></th>
    <td><h1><?php echo $row["hschool_name"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1>High Secondary school Board</h1></th>
    <td><h1><?php echo $row["hsboard"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1>High Secondary School Passing Year</h1></th>
    <td><h1><?php echo $row["passing_hyear"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1>High Secondary School Percent</h1></th>
    <td><h1><?php echo $row["hpercent"]; ?></h1></td>
  </tr>
    <tr>
      <th><h1>Graduation Univercity Name</h1></th>
    <td><h1><?php echo $row["univercity"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1>Graduation Degree</h1></th>
    <td><h1><?php echo $row["degree"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1>Graduation Percent</h1></th>
    <td><h1><?php echo $row["gpercent"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1>Graduation Passing Year</h1></th>
    <td><h1><?php echo $row["year"]; ?></h1></td>
  </tr>
    <tr>
      <th><h1>Post Graduation Degree</h1></th>
    <td><h1><?php echo $row["pgdegree"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1>Post Graduation Univercity Name</h1>/th>
    <td><h1><?php echo $row["pgunivercity"]; ?></h1></td>
   </tr>
   <tr>
     <th><h1>Post Graduation Passing Year</h1></th>
    <td><h1><?php echo $row["pgyear"]; ?></h1></td>
  </tr>
  <tr>
      <th><h1>Post Graduation Percent</h1</th>
    <td><h1><?php echo $row["pgpercent"]; ?></h1</td>
   </tr>
   <tr>
    <th><h1>Other Degree</h1></th>
    <td><h1><?php echo $row["otherdegree"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1>Other Univercity Name</h1></th>
    <td><h1><?php echo $row["otherunivercity"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1>Other Univercity Passing Year</h1></th>
    <td><h1><?php echo $row["otheryear"]; ?></h1></td>
  </tr>
  <tr>
    <th><h1>Other Univercity Percent</h1></th>
    <td><h1><?php echo $row["otherpercent"]; ?></h1></td>
</tr>
   ...
   ?> 
    <button type="submit" class=" btn-primary" style="border-radius:25px;size:65px;height:35px;width:64px;"><a href="showintern.php" style="color:white; font-size:15px;">BACK</a></button>
