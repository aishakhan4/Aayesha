...
<div class="container">
		<div class="card">
			<div class="card-header">
				<h2>
					<a class="btn btn-info float-right" href="takeempattend.php"><h1>Take Addendance</h1></a>
				</h2>
			</div>
<?php
	$results_per_page = 6;
$qry="SELECT DISTINCT att_time FROM emp_attendance";
$rs=readrecord($qry);
...
$query="SELECT DISTINCT att_time FROM emp_attendance LIMIT " . $page_first_result . ',' . $results_per_page;  
...
?>
				...
				<form action="" method="post">
					<table class="table table-striped">
						...
						<tr>
							...
							<td>
							<a class="btn btn-primary" href="emp_view.php?att_time=<?php echo $row["att_time"];?>"><h1>View</h1></a>
							</td>
						</tr>
						<?php 
						$i++;
        ...
        <?php
				 ...
				 if($page>=2){   
					echo " <li class='page-item' style='border:none;'> <a  class='page-link' style='border:none;' href='empdate_view.php?page=".($page-1)."'> <h1> Prev </h1></a></li>";   
				}
				for($i = 1; $i<= $number_of_page; $i++) {  
        echo '<li class="page-item"> <a class="page-link" href = "empdate_view.php?page=' . $i . '"><h1 style=>' . $i . ' </h1></a></li>';  
	}
	
	if($page<$number_of_page){ 
  
		echo "<li class='page-item' style='border:none;'><a  class='page-link' style='border:none;' href='empdate_view.php?page=".($page+1)."'> <h1> Next </h1></a></li>";   
	}   
	echo "</ul>"
