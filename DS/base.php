        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <a href="showintern.php"> <span>SHOW  INTERNS</span></a>
              <a href="takeinternattend.php"> <span>ATTENDANCE</span></a>
            </ul>
          </li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <a href="showtraine.php"> <span>SHOW TRAINEES</span></a>
              <a href="taketraineattend.php"> <span>ATTENDANCE</span></a>
            </ul>
          </li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <a href="showemp.php"> <span>SHOW EMPLOYEES</span></a>
              <a href="takeempattend.php"> <span>ATTENDANCE</span></a>
            </ul>
          </li>
