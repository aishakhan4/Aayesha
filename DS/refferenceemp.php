      ...
      <form name="myformcont" class="my-2" action="" method="POST">
        ...
        <div class="row jumbotron">
          ...
          <div class="col-sm-6 form-group">
            ...
            <input type="text" class="form-control" name="design" id="name-l" placeholder=" Designation" required style="font-size:15px;">
          </div>
          ...
          <div class="col-sm-6 form-group">
            ...
            <input type="text" class="form-control" name="question" id="name-l" placeholder=" How Do You Know Him/Her" required style="font-size:15px;"> 
          </div>   <div class="col-sm-6 form-group">
             <label for="passing year">Relationship With Employee</label>
            <input type="text" class="form-control" name="relationship" id="name-l" placeholder=" Reletionship with Employee" required style="font-size:15px;"> 
          </div>   <div class="col-sm-6 form-group">
          ...
          <div class="col-sm-6 form-group">
            ...
            <input type="text" class="form-control" name="department" id="name-l" placeholder=" Department name" required style="font-size:15px;"> 
          </div>
