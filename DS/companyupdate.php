 ...
 {  
      for($i=0; $i<$number; $i++)  
      {
       if( $_POST["skill"][$i] != '' && $_POST["position"][$i] != '' && $_POST["experience"][$i] != '' ) 
           ...
           $qry="update skill set skill='$skills', position='$positions', experience='$experiences'  where id=$pid";
...
$relationships="";
$belongs_department="";	
$qry="select * from companydetail where id='$pid'";
$rs=readrecord($qry);
...
$contactnumber=$row["cont_num"];
$companyemail=$row['Email'];
$details=$row["gotdetails"];
$relationships=$row["relationships"];
$belongs_department=$row["belongs_department"];
    ...
    <div class="card-body">
     <div class="container">
      <form name="myformcont" class="my-2" action="" method="POST">
        ...
        <input type="hidden" name="id" value="<?php echo $pid; ?>">
          ...
          <!--<div class="col-sm-6 form-group" style="margin-top: -20px;"> -->
            ...
            <input type="text" class="form-control" name="name" id="name-f" placeholder="  Name" required value="<?php echo $companyname;?>" style="font-size:15px;"><br>
          </div>
          <div class="col-sm-6 form-group">
            <label for="besignation">Designation</label>
            <input type="text" class="form-control" name="design" id="name-l" placeholder=" Designation" required value="<?php echo $designation;?>" style="font-size:15px;" >
          </div>
          <div class="col-sm-6 form-group">
            <label for="contact no.">contact no.</label>
            <input type="phone" class="form-control" name="contact" id="name-l" placeholder=" Contact no." required value="<?php echo $contactnumber;?>"style="font-size:15px;" >
          </div>
          <div class="col-sm-6 form-group">
             <label for="passing year">Email</label>
            <input type="text" class="form-control" name="comemail" id="name-l" placeholder=" Email" required value="<?php echo $companyemail;?>" style="font-size:15px;"> 
          </div>
       
          <div class="col-sm-6 form-group">
             <label for="passing year">How Do You Knoe Him/Her</label>
            <input type="text" class="form-control" name="question" id="name-l" placeholder=" How Do You Knoe Him/Her" required value="<?php echo $details;?>" style="font-size:15px;"> 
          </div>   <div class="col-sm-6 form-group">
             <label for="passing year">Relationship With Employee</label>
            <input type="text" class="form-control" name="relationship" id="name-l" placeholder=" Reletionship with Employee" required value="<?php echo $relationships;?>" style="font-size:15px;"> 
          </div>   <div class="col-sm-6 form-group">
             <label for="passing year">Belongs To Department</label>
            <input type="text" class="form-control" name="department" id="name-l" placeholder=" Department name" required value="<?php echo $belongs_department;?>" style="font-size:15px;"> 
          </div>
      ...
      <div class="col-sm-12 form-group mb-0">
       <button class="btn btn-primary float-right" name="btn4" style="font-size:20px;">Submit</button>
     </div>
