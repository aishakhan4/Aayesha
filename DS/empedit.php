...
<div >
    ...
    <div class="card-body">
     <div class="container">
      <form name="myformcont" class="my-2" action="educationupdate.php?id=<?php echo $row["id"];?>" method="POST" enctype="multipart/form-data">
 ...
 <div class="col-sm-3 form-group" style="margin-top: -20px;">
    ...
    <div class="picture-container">
        <div class="picture" style="height: 170px; width: 170px; margin-top: 25px;">
         ...
         <h6 class="" style="font-size:15px;">Choose Picture</h6>
          ...
          <div class="col-sm-6 form-group">
            ...
            <input type="text" class="form-control" name="aadhar" id="name-f" placeholder=" Adhar Number" required value="<?php echo $aadhar;?>" style="font-size:15px;">
          </div>
          <div class="col-sm-6 form-group">
            <label for="cost_center"> Pan Card</label>
            <input type="text" class="form-control" name="pan" id="cost_center" placeholder=" Pain Card Number" required value="<?php echo $pan;?>" style="font-size:15px;">
          </div>
      ...
      <div class="col-sm-6 form-group">
        ...
        <input type="text" class="form-control" name="fname" id="description" placeholder=" Father Name" required value="<?php echo $fname;?>" style="font-size:15px;">
      </div>
      <div class="col-sm-6 form-group">
        <label for="pan_no"> Father Occoupation</label>
        <input type="text" class="form-control" name="occupation" id="pan-no" placeholder=" Father Occoupation " required value="<?php echo $occupation;?>" style="font-size:15px;">
      </div>
      <div class="col-sm-6 form-group">
        <label for="created_on">Father Number</label>
        <input type="int" class="form-control" name="fnum" id="pan-no" placeholder=" Father Number" required value="<?php echo $fnum;?>" style="font-size:15px;">
      </div>
      ...
      <div class="col-sm-12 form-group mb-0">
       <button type="submit"  class="btn btn-primary float-right" name="btn1" style="font-size:15px;">Next</button>
     </div>
