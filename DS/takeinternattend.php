...
<div class='alert alert-danger' style="display: none;"><strong>Error !</strong> Student Roll Missing !</div>
      ...
      $number_of_page = ceil ($fetch/ $results_per_page);
			...
			$query = "SELECT * FROM internpersnoldetail LIMIT " . $page_first_result . ',' . $results_per_page;  
				...
				<form action="" method="post">
					<table class="table table-striped">
						<tr>
							...
							<th width="25%"><h1>Intern ID</h1></th>
						...
						<td><h1><?php echo $i;?></h1></td>
							...
							<td><h1>
								<input type="radio" name="attend[<?php echo $row['uid'];?>]" value="present">P
								<input type="radio" name="attend[<?php echo $row['uid'];?>]" value="absent">A
						</h1>	</td>
						</tr>
<?php
$i++;
