...
$b="jff";
  extract($_POST);
    ...
    $qry="insert into tranprofessionaldetail(school_name, board, percent, passing_year, school_marksheet, hschool_name,hsboard, passing_hyear,
    hpercent, hschool_marksheet, univercity, degree, gpercent,year, g_marksheet, pgdegree, pgunivercity, pgyear, pgpercent,
     pg_marksheet, otherdegree, otherunivercity, otheryear, otherpercent, other_marksheet,payment)
...
<div class="col-sm-6 form-group">
        ...
        <select input type="text" class="form-control" name="cash" id="address-1" placeholder=" Blood Group" required>
...
<div class="col-sm-6 form-group">
 ...
 -->      <div class="col-sm-12">
      ...
      <div class="col-sm-12 form-group mb-0">
       <button class="btn btn-primary float-right" name="btn2">Submit</button>
     </div>
